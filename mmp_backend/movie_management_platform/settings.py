"""
Django settings for movie_management_platform project.
...
ROOT_URLCONF = "movie_management_platform.urls"
...
WSGI_APPLICATION = "movie_management_platform.wsgi.application"


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

# Database from docker .env
DATABASES = {
